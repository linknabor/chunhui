...
//	public CouponSeed saveSeed(CouponSeed seed);//创建现金券活动
	public CouponSeed createOrderSeed(long userId,ServiceOrder order);
	
	public CouponRule saveRule(CouponRule rule);
	
//	public void removeCouponRule(long ruleId);
//	public void invalidCouponRule(long ruleId);
//	public void removeCouponSeed(long seedId);
...
//	public void batchAddCoupon(CouponSeed seed,List<Long> userIds);
