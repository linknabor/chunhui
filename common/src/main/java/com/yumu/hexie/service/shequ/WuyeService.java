...
public interface WuyeService {
	...
	// 10.缴费
	public WechatPayInfo getPrePayInfo(String userId,String billId,String stmtId,String openId, String couponUnit, String couponNum) throws ValidationException;
	// 11.通知已支付
