...
//                //.and()
//        		.authorizeRequests().antMatchers("/","/logintest/*","/backend/conf/tree.json").permitAll()
//                .and()
//                .authorizeRequests().antMatchers("/s/backend/**").authenticated()
//                .and().formLogin().loginPage("/s/backend/login").permitAll()
//                .successHandler(restAuthSuccessHandler)
//                .failureHandler(restAuthFailureHandler)
//                .and().logout().logoutUrl("/s/backend/logout").permitAll().logoutSuccessUrl("/backend/login.html")
